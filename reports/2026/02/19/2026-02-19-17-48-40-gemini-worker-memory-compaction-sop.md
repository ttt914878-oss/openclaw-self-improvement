...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      date: 'Thu, 19 Feb 2026 08:50:32 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=164',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'ec9da8b15ca3f49a',
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Thu, 19 Feb 2026 08:50:44 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=6798',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '3b022adaaff493cc',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Error when talking to Gemini API Full report available at: /tmp/gemini-client-error-Turn.run-sendMessageStream-2026-02-19T08-50-56-010Z.json RetryableQuotaError: No capacity available for model gemini-3-flash-preview on the server
